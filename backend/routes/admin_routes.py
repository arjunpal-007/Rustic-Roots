...
from models import db, Product, Video, Testimonial
import os
...
# 🎥 ADD VIDEO
@admin_routes.route("/admin/add-video", methods=["POST"])
@admin_login_required
def add_video():
    ...
    return redirect("/static/admin/videos.html?success=1")


# 💬 ADD TESTIMONIAL
@admin_routes.route("/admin/add-testimonial", methods=["POST"])
@admin_login_required
def add_testimonial():
    name = request.form["name"]
    ...
    return redirect("/static/admin/testimonials.html?success=1")
