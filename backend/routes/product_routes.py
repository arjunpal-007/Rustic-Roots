...
from models import Product, Order, db, Review, Video, Testimonial
...
@product_routes.route("/add-testimonial", methods=["POST"])
def add_testimonial():
    data = request.get_json()
...
# 🎥 GET VIDEOS API
@product_routes.route("/api/videos", methods=["GET"])
def get_videos():
        ...
        return jsonify([
            {
                ...
                "description": "Discover our complete range of natural skincare products.",
                "file_path": "/static/assets/videos/Test video rustic roots.mp4"
            },
            {
                "id": 1,
                "title": "How It's Made",
                "description": "See our eco-friendly production process in action.",
                "file_path": "/static/assets/videos/Test video rustic roots.mp4"
            }
        ])
...
@product_routes.route("/api/testimonials", methods=["GET"])
        ...
        return jsonify([
            {
                "id": 0,
                "name": "Priya Sharma",
                "comment": "Absolutely love the natural ingredients! My skin feels so refreshed and healthy.",
                "rating": 5
            },
            {
                "id": 1,
                "name": "Rahul Kumar",
                "comment": "Great quality products at reasonable prices. The customer service is excellent too.",
                "rating": 5
            },
            {
                "id": 2,
                "name": "Anjali Patel",
                "comment": "These products have transformed my skincare routine. Natural, effective, and affordable.",
                "rating": 5
            }
        ])
