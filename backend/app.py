...
@app.route("/videos")
def videos_page():
    return send_from_directory("static/customer", "videos.html")

@app.route("/testimonials-page")
def testimonials_page():
    return send_from_directory("static/customer", "testimonials.html")

@app.route("/reviews")
def reviews_page():
    return send_from_directory("static/customer", "reviews.html")
